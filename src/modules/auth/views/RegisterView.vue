<template>
    ...
    >
        ...
        <div class="wrap-input100 validate-input" data-validate="Ingrese password">
            <input v-model="userForm.password" autocomplete="current-password" class="input100" type="password" placeholder="Contraseña" required>
            <span class="focus-input100" data-placeholder="&#xe80f;"></span>
        </div>
...
export default {
    ...
    setup(){
        ...
        return{
            userForm,
            onsubmit: async() => { 
                const { ok, message }  = await createUsers( userForm.value )
